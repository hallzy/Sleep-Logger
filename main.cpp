...
// Contains the toFile class
#include "getInput.h"
// Holds all of the different times, such as StartTime, DeltaTime, and WakeTime
// Also contains all the update functions
#include "time.h"
// All the methods related to sending information to the text file
#include "fileOutput.h"
// The part of the program that displays and records the times.
#include "record.h"
